      ...
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-body">
                  <form class="box" action="Valid_Login.php" method="post">
                      <h1>Entrar</h1>
                      ...
                      <div>
                          <label for="agreement" id="agreement-label"><a href="index-cadastroj.php" class="agreement">Recuperar Senha</a></label><br> 
                      </div>
                  </form>
              </div>
          </div>
